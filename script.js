...
dark.onmouseover = function () {
    document.querySelector("nav div#right ul#slider").style.visibility = "visible";
}
document.querySelector("nav div#right ul#slider li:first-child").onclick = function () {
          document.querySelector("nav div#right ul#slider,nav div#right ul#slider li").style.visibility = "hidden";
...
document.querySelector("nav div#right ul#slider li:nth-child(2)").onclick = function () {
                  document.querySelector("nav div#right ul#slider").style.visibility = "hidden";
